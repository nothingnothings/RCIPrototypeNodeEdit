...
exports.getStartingPage = (req, res, _next) => {
  fs.readFile(
    path.join('page-text' + '/page-1' + '/banner-text.txt'),
    (err, data) => {
      if (err) {
        throw err;
      }
...
exports.getOQueFazemosPage = (req, res, next) => {
  fs.readFile(
    path.join('page-text' + '/page-2' + '/banner-text.txt'),
    (err, data) => {
      if (err) {
        throw err;
      }
...
exports.getQuemSomosPage = (req, res, next) => {
  fs.readFile(
    path.join('page-text' + '/page-3' + '/banner-text.txt'),
    (err, data) => {
      if (err) {
        throw err;
      }
...
exports.getRCInsightsPage = (req, res, next) => {
  fs.readFile(
    path.join('page-text' + '/page-4' + '/banner-text.txt'),
    (err, data) => {
      if (err) {
        throw err;
      }
